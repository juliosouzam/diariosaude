                    ...
                    return GestureDetector(
                      onTap: () async {
                        if (_formKey.currentState.validate()) {
                          ...
                          eventData.cid = cid;
                          eventData.photo = eventStore.photo;
                          eventData.document = eventStore.document;

                          bool result = false;
                          result = await eventStore.addEventData(
                              eventData, loginStore.currentUser.value.uid);
                          if (result) {
                            _onSuccess();
                          } else {
                            _onFailure();
